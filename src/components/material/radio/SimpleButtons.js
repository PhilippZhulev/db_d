        ...
        return (
            <div className={classes.root}>
                ...
                <FormControl component="fieldset" className={classes.formControl}>
                    <FormLabel component="legend" style={{color: "white"}}><span>ЧКД CAGR</span><span style={{color:"#6d7b87"}}>, %</span></FormLabel>
                    <RadioGroup
                        aria-label="Gender"
                        name="gender1"
                ...
                <FormControl component="fieldset" className={classes.formControl}>
                    <FormLabel component="legend" style={{color: "white"}}><span>NIM</span><span style={{color:"#6d7b87"}}>, %</span></FormLabel>
                    <RadioGroup
                        aria-label="Gender"
                        name="gender1"
                        className={classes.group}
                ...
                <div className={"group"}>
                <FormControl component="fieldset" className={classes.formControl}>
                    <FormLabel component="legend" style={{color: "white"}}><span>CIR</span><span style={{color:"#6d7b87"}}>, %</span></FormLabel>
                    <RadioGroup
                        aria-label="Gender"
                        name="gender1"
                        className={classes.group}
                ...
                <FormControl component="fieldset" className={classes.formControl}>
                    <FormLabel component="legend" style={{color: "white"}}><span>COR</span><span style={{color:"#6d7b87"}}>, %</span></FormLabel>
                    <RadioGroup
                        aria-label="Gender"
                        name="gender1"
                        className={classes.group}
