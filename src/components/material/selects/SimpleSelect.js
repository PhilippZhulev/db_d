      ...
      store.subscribe(() => {
          ...
          if(change === "change_tab") {
              switch (getState.states) {
                  ...
                  case 2: this.driverActive("driver_router_group", 1, 1); this.setState({seletDisable: true}); break;

                  case 3: this.driverActive("driver_router_group", 2, 2); this.setState({seletDisable: true}); break;

                  case 4: this.driverActive("driver_router_group", 3, 3); this.setState({seletDisable: true}); break;
