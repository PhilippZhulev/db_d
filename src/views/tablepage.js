        ...
        for (let i=0; i<this.state.table.COR.length; i++){
            ...
            for (let j=0; j<this.state.table.CAGR.length;j++){
                ...
                if ((i===0)&&(j===0)){
                    ...
                    second_header.unshift(<div className={"top_header second hidden column"} key={Math.random()} style={Object.assign({color: this.props.templ.primary.textValueMain, lineHeight:"99%", fontSize:"0.875rem"}, obj1)}>ЧКД<br/>COR</div>);
